...
function first2() {
  ...
  while (!match) {
    for (e of input1) {
      freq += e;
      if (reachedVals.find(o => o === freq)) {
        match = freq;
        break;
      }
      reachedVals.push(freq);
    }
  }
  return match;
}